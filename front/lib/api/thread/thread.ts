...
export const listThreads = (
  ...
  return makeRequest<ListThreads200Item[]>({ url: `/api/threads/`, method: "GET", params, signal }, options)
}
...
export const createThread = (
  ...
  return makeRequest<CreateThread200>(
    {
      url: `/api/threads/`,
      method: "POST",
...
export const useCreateThread = <TError = ErrorType<unknown>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof createThread>>, TError, { data: CreateThreadBody }, TContext>
  request?: SecondParameter<typeof makeRequest>
...
export const getThreadById = (id: number, options?: SecondParameter<typeof makeRequest>, signal?: AbortSignal) => {
  return makeRequest<GetThreadById200>({ url: `/api/threads/${id}`, method: "GET", signal }, options)
}
...
export const updateThread = (
  ...
  return makeRequest<UpdateThread200>(
    {
      url: `/api/threads/${id}`,
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
...
export const useUpdateThread = <TError = ErrorType<unknown>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof updateThread>>,
    TError,
    { id: number; data: UpdateThreadBody },
...
export const deleteThread = (id: number, options?: SecondParameter<typeof makeRequest>) => {
  return makeRequest<DeleteThread200>({ url: `/api/threads/${id}`, method: "DELETE" }, options)
}
...
export const useDeleteThread = <TError = ErrorType<unknown>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof deleteThread>>, TError, { id: number }, TContext>
  request?: SecondParameter<typeof makeRequest>
