...
export function CommentList({ comments, threadId, session }: CommentListProps) {
  ...
  const handleEditComment = (commentId: number) => {
    ...
    sendGAEvent({
      event: "comment_edit_clicked",
      params: { comment_id: commentId, thread_id: threadId },
    })
  }
  ...
  const handleDeleteComment = async (commentId: number) => {
    ...
    try {
      ...
      sendGAEvent({
        event: "comment_delete_error",
        params: { comment_id: commentId, thread_id: threadId, error: (error as any).message },
      })
